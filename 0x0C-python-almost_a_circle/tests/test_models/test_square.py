#!/usr/bin/python3
"""
Module that contains the square class unittest cases
for all methods and attributes of the square class.
"""
...
class Test_Square_instantiation(unittest.TestCase):
    """Tests for the instantation of the Square class"""

    def test_Square_isinstance_of_Base(self):
    ...
    def test_four_args_with_id(self):
        self.assertEqual(3, Square(10, 2, 2, 3).id)
    ...
    def test_size_getter_method(self):
        self.assertEqual(7, Square(7, 2, 3, 9).size)
    ...
    def test_y_getter_method(self):
        self.assertEqual(0, Square(14).y)

class TestSquare_size(unittest.TestCase):
    """tests for size initialization of the Square class."""

    def test_str_size_passed(self):
...
class TestSquare_x_argument(unittest.TestCase):
    """Tests for initialization of Square x attribute."""
...
class TestSquare_y(unittest.TestCase):
    """tests for initialization of Square y attribute."""

    def test_None_y_arg_passed(self):
    ...
    def test_float_y_arg_passed(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(4, 5, 2.4)
    ...
    def test_inf_y_value_used(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(1, 3, float('inf'))

    def test_nan_y_passed(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(3, 1, float('nan'))
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """tests for the order of Square attribute initialization."""
...
class TestSquare_area(unittest.TestCase):
    ...
    def test_area_changed_size_attributes(self):
        s = Square(2, 0, 2, 1)
        s.size = 12
        self.assertEqual(144, s.area())
...
class TestSquare_stdout(unittest.TestCase):
    """tests for __str__ and display methods of Square class."""
    ...
    def test_str_method_size_x(self):
        s = Square(10, 6)
        correct = "[Square] ({}) 6/0 - 10".format(s.id)
...
class TestSquare_update_args_Method(unittest.TestCase):
    """tests for update args method of the Square class."""
    ...
    def test_update_args_size_negative_value(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            s.update(89, -3)
...
class TestSquare_update_kwargs_Method(unittest.TestCase):
    """tests for update kwargs method of Square class."""
    ...
    def test_update_kwargs_width_setter_method(self):
        s = Square(10, 10, 10, 10)
        s.update(id=89, size=8)
        self.assertEqual(8, s.width)

    def test_update_kwargs_height_setter_method(self):
        s = Square(10, 10, 10, 10)
    ...
    def test_update_kwargs_invalid_x_value(self):
        s = Square(10, 23, 12, 16)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            s.update(x="wrong")
    ...
    def test_update_kwargs_wrong_keys(self):
        s = Square(13, 10, 10, 12)
        s.update(z=5, a=10)
        self.assertEqual("[Square] (12) 10/10 - 13", str(s))
...
class TestSquare_to_dictionary_class_method(unittest.TestCase):
    """tests for to_dictionary method of the Square class."""

    def test_to_dictionary_correct_arg(self):
        s = Square(15, 3, 1, 89)
        correct = {'id': 89, 'x': 3, 'size': 15, 'y': 1}
    ...
    def test_to_dictionary_arg_method(self):
        s = Square(10, 10, 12, 10)
        with self.assertRaises(TypeError):
            s.to_dictionary(2)
